...
num_lines = 1 ;
usual_values = {'200','100','1800','2300','0.01','100','2','20'} ;
answer = inputdlg(prompt,settitle,num_lines,usual_values,'on') ;
...
%            u1(i) = 2.d0*u1nm1(i) - u1nm2(i) + (mu * value_du_dxx * dt2)/rho;
%        end
...
%--------------------------------------------------------------------------           
    elseif OPT4
        ...
        for i=3:(NX-1)
            ...
            u1(i) = 2.d0*u1nm1(i) - u1nm2(i) + (mu * value_du_dxx1 * dt2)/rho ;
        end
