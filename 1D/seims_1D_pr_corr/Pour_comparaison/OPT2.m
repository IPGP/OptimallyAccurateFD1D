...
%--------------------------------------------------------------------------
  ...
  for i=2:NX
    ...
    dA(1:3,1:3,i-1) = (rho(i)/DELTAT^2)*[1/12 10/12 1/12; -2/12 -20/12 -2/12; 1/12 10/12 1/12]-(rho(i)/DELTAT^2)*[0 1 0; 0 -2 0; 0 1 0];
    dK(1:3,1:3,i-1) = (mu(i)/DELTAX^2)*[1/12 -2/12 1/12; 10/12 -20/12 10/12; 1/12 -2/12 1/12]-(mu(i)/DELTAX^2)*[0 0 0; 1 -2 1; 0 0 0];
  end  
